...
int main(){
  ...
  /*scores = &number; The array name is a pointer, but a special pointer that kind of identifies the entire array
                      You'll get the error : incompatible types in assignment of 'int*' to 'int[10]'*/
  cout << "p_score : " << p_score << endl;// Pointer
